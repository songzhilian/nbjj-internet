...
@Alias(value = "AcdDutySimpleHuman")
public class AcdDutySimpleHuman  implements java.io.Serializable {
	...
	public String getClcxbj() {
		return clcxbj;
	}

	public void setClcxbj(String clcxbj) {
		this.clcxbj = clcxbj;
	}
